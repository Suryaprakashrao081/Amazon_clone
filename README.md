...
<body>
    <div class="container">
        <nav>
          <div class="logo">
            <img decoding="async" src="logo.png" alt="main-logo">
            <span>.in</span>
          </div>
      
          <div class="set_location ln-height border">
            <p class="first-line">Delivering to Hyderabad 502032</p>
            <p class="second-line">
          ...
          <div class="choose_country border">
            <div class="flag">
              <img decoding="async" src="indian flag.png" alt="country flag" height="25px" />
            </div>
        ...
        <div class="cards">
          ...
          <div class="card">
            ...
            <img decoding="async" src="Watch.jpg" alt="" />
            <a href="">Shop Now</a>
          </div>
          <!-- card 2 -->
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="A1.jpg" alt="" />
                <p>Home decor</p>
              </div>
              <div class="product">
                <img decoding="async" src="A2.jpg" alt="" />
                <p>Home furnishings</p>
              </div>
              <div class="product">
                <img decoding="async" src="A3.jpg" alt="" />
                <p>Home storage</p>
              </div>
              <div class="product">
                <img decoding="async" src="A4.jpg" alt="" />
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="B1.jpg" alt="" />
                <p>Up to 75% off | boAt</p>
              </div>
              <div class="product">
                <img decoding="async" src="B2.jpg" alt="" />
                <p>Up to 75% off | boult</p>
              </div>
              <div class="product">
                <img decoding="async" src="B3.jpg" alt="" />
                <p>Up to 75% off | Noise</p>
              </div>
              <div class="product">
                <img decoding="async" src="B4.jpg" alt="" />
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="C1.jpg" alt="" />
                <p>Clothing</p>
              </div>
              <div class="product">
                <img decoding="async" src="C2.jpg" alt="" />
                <p>Footwear</p>
              </div>
              <div class="product">
                <img decoding="async" src="C3.jpg" alt="" />
                <p>Watches</p>
              </div>
              <div class="product">
                <img decoding="async" src="C4.jpg" alt="" />
                <p>Bags &amp; wallet</p>
              </div>
            </div>
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="D1.jpg" alt="" />
                <p>Spin mops, wipes &amp; more</p>
              </div>
              <div class="product">
                <img decoding="async" src="D2.jpg" alt="" />
                <p>Bathromm hardware &amp; accessories</p>
              </div>
              <div class="product">
                <img decoding="async" src="D3.jpg" alt="" />
                <p>Hammers, screwdrivers &amp; more</p>
              </div>
              <div class="product">
                <img decoding="async" src="D4.jpg" alt="" />
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="E1.jpg" alt="" />
                <p>Gaming Accessories</p>
              </div>
              <div class="product">
                <img decoding="async" src="E2.jpg" alt="" />
                <p>Keyboard and Mice</p>
              </div>
              <div class="product">
                <img decoding="async" src="E3.jpg" alt="" />
                <p>Stands, Cables &amp; more</p>
              </div>
              <div class="product">
                <img decoding="async" src="E4.jpg" alt="" />
                <p>Backpacks</p>
              </div>
            </div>
            <a href="">See all offers</a>
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="F1.jpg" alt="" />
                <p>Women's Clothing</p>
              </div>
              <div class="product">
                <img decoding="async" src="F2.jpg" alt="" />
                <p>Footwear+Handbags</p>
              </div>
              <div class="product">
                <img decoding="async" src="F3.jpg" alt="" />
                <p>Watches</p>
              </div>
              <div class="product">
                <img decoding="async" src="F4.jpg" alt="" />
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="G1.jpg" alt="" />
                <p>Air conditioners</p>
              </div>
              <div class="product">
                <img decoding="async" src="G2.jpg" alt="" />
                <p>Refrigerators</p>
              </div>
              <div class="product">
                <img decoding="async" src="G3.jpg" alt="" />
                <p>Microwaves</p>
              </div>
              <div class="product">
                <img decoding="async" src="G4.jpg" alt="" />
          ...
          <div class="card">
            ...
            <div class="cardContainer">
              <div class="product">
                <img decoding="async" src="H1.jpg" alt="" />
                <p>Starting ₹299 | Bikes, trikes &amp; ride-ons</p>
              </div>
              <div class="product">
                <img decoding="async" src="H2.jpg" alt="" />
                <p>Starting ₹149 | Sport &amp; outdoor</p>
              </div>
              <div class="product">
                <img decoding="async" src="H3.jpg" alt="" />
                <p>Starting ₹99 | Soft toys</p>
              </div>
              <div class="product">
                <img decoding="async" src="h4.jpg" alt="" />
